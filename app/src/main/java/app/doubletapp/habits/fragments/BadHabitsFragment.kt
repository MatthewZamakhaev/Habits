...
import app.doubletapp.habits.databinding.FragmentBadHabitsBinding
...
class BadHabitsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentBadHabitsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerList = sharedPreferencesManager.loadBadData()
    ...
    private val habitClickListener = object : OnHabitClickListener {
        ...
        override fun onDelete(model: Habit) {
            ...
            sharedPreferencesManager.saveBadData(recyclerList)
        }
    }
